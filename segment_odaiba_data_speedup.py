...
TEXT_PROMPTs = ["car", "bus","motorcycle", "bicycle", "human",
                "traffic light", "guard rail", "wall", "pole", "sign",
                "road marker"]#"road", "ground"]
BOX_TRESHOLD = 0.3
TEXT_TRESHOLD = 0.25
...
result_bbox_dir = f'results_v2/bbox/png/{data_name}/{camera_name}'
result_bbox_concat_dir = f'results_v2/bbox_concat/png/{data_name}/{camera_name}'
result_ann_speed_dir = f'results_v2/ann_speed/{data_name}/{camera_name}'
...
result_dir = f'results_v2/ann/png/{data_name}/{camera_name}'
result_concat_dir = f'results_v2/concat/png/{data_name}/{camera_name}'
...
for i, image_p in tqdm(enumerate(image_paths)):
    ...
    for idx, TEXT_PROMPT in enumerate(TEXT_PROMPTs):
        ...
        boxes, logits, phrases = predict(
            ...
            text_threshold=TEXT_TRESHOLD, device=device
        )
